...
# rename one column name
colnames(df_seg1C)[colnames(df_seg1C)=="X34442"]<-"Sim"      #change seg ID
...
#converting the data first to time series
df_joinedCtime=ts(df_joinedC[,4],start=c(2001,01),frequency = 12)
...
# rename one column name
colnames(df_seg1B)[colnames(df_seg1B)=="X34668"]<-"Sim"      #change seg ID
